...
function JoinScreen({ getMeetingAndToken }) {
  ...
  const onClick = async (type) => {
    await getMeetingAndToken(meetingId, type);
  };
  ...
  return (
    <div className="container text-center" style={{ backgroundColor: '#87CEEB', minHeight: '100vh' }}>
      ...
      >
        <Button onClick={() => onClick("CONFERENCE")} className="btn-primary">
          Create Meeting <FaPlusCircle />
        </Button>
      </OverlayTrigger>
      <br />
      <br />
      ...
      >
        <Button variant="success" onClick={() => onClick("VIEWER")}>
          <FaPlusCircle />
        </Button>
      </OverlayTrigger>
    </div>
